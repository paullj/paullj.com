...
![Point clouds are sparse especially at the edge of a LiDAR's range](content/images/placement-1.png)
...
![Having a good idea what's between the points is valuable and can help with perception](content/images/placement-2.png)
...
![Why is compressed sensing of interest?](content/images/placement-3.png)
...
![Reconstruction using only 5% of the original signal](content/images/placement-4.png)
...
![Close up comparison between original, compressed sensing and linear interpolation](content/images/placement-5.png)
